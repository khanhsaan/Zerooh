 ...
 * Errors are handled via `logErrorAndSetState` + `displayError` per CLAUDE.md.
 */
const HomeScreen: React.FC = () => {
  ...
  const totalMeals = products?.length ?? 0;
          ...
          <>
            ...
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>
                {selectedCategory === 'All' ? '🔥 Hot Deals' : `${CATEGORIES.find(c => c.label === selectedCategory)?.emoji} ${selectedCategory}`}
              </Text>
